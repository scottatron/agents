...
| | Codex | Claude | Gemini | Cursor | Copilot VS Code | Copilot CLI | Antigravity | Windsurf | OpenCode |
|:--|:-----:|:------:|:------:|:------:|:---------------:|:-----------:|:-----------:|:--------:|:--------:|
| **Config** | `.codex/config.toml` | CLI commands | `.gemini/settings.json` | `.cursor/mcp.json` | `.vscode/mcp.json` | `.copilot/mcp-config.json` + `.agents/bin/copilot` | Global `mcp.json` | Global `mcp_config.json` | `opencode.json` |
...
<table>
  ...
  <tr>
    ...
    <td align="center">✅</td>
    <td align="center">✅</td>
    <td>Writes <code>.copilot/mcp-config.json</code> + wrapper <code>.agents/bin/copilot</code> (adds <code>--additional-mcp-config</code>)</td>
  </tr>
  <tr>
...
│   │   └── my-skill/SKILL.md
│   ├── bin/
│   │   └── copilot                  ← Wrapper for Copilot CLI extra MCP config
